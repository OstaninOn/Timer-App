...
class TimerModel: NSObject, ObservableObject, UNUserNotificationCenterDelegate {
    ...
    @Published var timerStrinngValue: String = "00:00"
    ...
    func StartTimer() {
        ...
        timerStrinngValue = "\(hour == 0 ? "" : "\(hour):")\(minutes >= 10 ? "\(minutes)" : "0\(minutes)"):\(seconds >= 10 ? "\(seconds)" : "0\(seconds)")"
    ...
    // MARK: - Requesting Natification Access
   ...
   //MARK: - Updating Timer
    ...
    func addNotification() {
        ...
        content.sound = UNNotificationSound(named:UNNotificationSoundName(rawValue: "soundAlarm.mp3"))
